...
import { Menu, X, Calendar, Users, ClipboardList, Settings, Plus, FileText } from 'lucide-react';
...
const Layout: React.FC = () => {
  ...
  const shouldShowFloatingButton = () => {
    ...
    // charts 페이지에서는 floating button 표시하지 않음
  ...
  const menuItems = [
    ...
    { path: '/dashboard/charts', icon: FileText, label: t('navigation.charts') },
